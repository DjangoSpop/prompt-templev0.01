...
/**
 * Module 5: Advanced Techniques & Production Patterns
 *
 * Tree of Thoughts, RAG, fine-tuning, and production deployment
 */
...
export default function Module5Page() {
  ...
  const progress = useAcademyStore(selectModuleProgress('module-5'));

  // Check if user has unlocked this module
  const isUnlocked = unlockedModules.includes('module-5');
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-10">
          {showQuiz ? (
            <div>
              ...
              <QuizEngine quiz={module.quiz} moduleId="module-5" />
            </div>
          ) : (
            <div>
              <div className="mb-6">
