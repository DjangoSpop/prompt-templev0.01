...
/**
 * Module 4: Multi-Model Orchestration Strategy
 *
 * Learn to route tasks across GPT-4, Claude, Gemini, and more
 */
...
export default function Module4Page() {
  ...
  const progress = useAcademyStore(selectModuleProgress('module-4'));

  // Check if user has unlocked this module
  const isUnlocked = unlockedModules.includes('module-4');
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-10">
          {showQuiz ? (
            <div>
              ...
              <QuizEngine quiz={module.quiz} moduleId="module-4" />
            </div>
          ) : (
            <div>
              <div className="mb-6">
