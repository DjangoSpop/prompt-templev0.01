...
/**
 * Module 3: Prompt Typology & Use Cases
 *
 * Master 8 essential prompt types and learn when to use each
 */
...
export default function Module3Page() {
  ...
  const progress = useAcademyStore(selectModuleProgress('module-3'));

  // Check if user has unlocked this module
  const isUnlocked = unlockedModules.includes('module-3');
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-10">
          {showQuiz ? (
            <div>
              ...
              <QuizEngine quiz={module.quiz} moduleId="module-3" />
            </div>
          ) : (
            <div>
              <div className="mb-6">
