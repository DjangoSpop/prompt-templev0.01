 ...
 *
 * Design, build, and validate a production-grade prompt workflow
 */
...
export default function Module6Page() {
  ...
  const progress = useAcademyStore(selectModuleProgress('module-6'));

  // Check if user has unlocked this module
  const isUnlocked = unlockedModules.includes('module-6');
          ...
          {showQuiz ? (
            <div>
              <h2 className="text-3xl font-bold text-amber-400 mb-6">
                The Pharaoh&apos;s Final Trial
              </h2>
              <QuizEngine quiz={module.quiz} moduleId="module-6" />
            </div>
          ) : (
            <div>
              <div className="mb-6">
